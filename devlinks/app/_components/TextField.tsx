...
export default function TextField({placeholder, error, errorMessage, label, icon}: {
    ...
    return <div className="flex flex-col gap-1">
        ...
        <div className="relative">
            ...
            <input placeholder={placeholder} className={` ${icon ? "px-[44px]" : "px-4"} py-3 rounded-lg border border-light-gray placeholder:text-light-gray text-gray w-full focus:outline-none ${error ? "border-tomato text-tomato" : "focus:shadow-[0_0_25px_0_rgba(99,60,255,0.3)] focus:border-dark-lavender"}`}></input>
        </div>
    </div>
}