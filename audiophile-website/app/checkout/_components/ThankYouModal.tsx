...
function ThankYouModal() {
    ...
    return (
        <>
            ...
            <div
                className="absolute bg-white z-30 rounded-lg p-8 tablet:p-12 left-1/2 -translate-x-1/2 top-36 w-[327px] tablet:w-[540px] flex flex-col gap-4 tablet:gap-10">
                ...
                <div
                    className="rounded-lg overflow-hidden grid grid-rows-[5fr_4fr] tablet:grid-cols-[5fr_4fr] tablet:grid-rows-1">
                    <div className="bg-grey p-8 desktop:p-4 relative">
                        <div
                            className="grid grid-cols-[auto_2fr_2fr] mb-4 tablet:grid-cols-[auto_10fr_1fr] desktop:grid-cols-[auto_10fr_1fr] gap-2 items-center">
                            ...
                            <span
                                className="justify-self-end font-bold text-[15px] text-dark-grey">x{cart[0].quantity}</span>
                        </div>
                    ...
                    <div className="bg-black-light p-8 flex flex-col gap-4">
