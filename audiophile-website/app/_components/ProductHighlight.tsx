...
function ProductHighlight({name, description, image, type}: {
    ...
    if (type === "primary") return <div
        className="relative h-[600px] tablet:h-[720px] bg-earthy mt-6 text-center flex flex-col justify-center items-center rounded-lg gap-6 tablet:gap-24 p-6 overflow-hidden">
        ...
        <img className="absolute top-1 z-10 tablet:-top-56 tablet:scale-150"
    ...
    if (type === "secondary") return <div className="relative h-[320px] mt-6 rounded-lg overflow-hidden">
        ...
        <img className="absolute -z-10 h-full w-full object-cover hidden tablet:block" src={image[1]}
