...
function Button({type, children, link, fn, className}: {
    ...
    function ButtonPrimary() {
        return <button className={`w-40 h-12 bg-earthy hover:bg-earthy-light ${className}`}><span
    ...
    function ButtonTertiary() {
        return <button className={`w-[58px] h-[18px] group flex items-center gap-[13px] ${className}`}><span
