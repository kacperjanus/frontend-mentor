...
function MainArticle() {
    return (
        <div className="grid grid-cols-2 grid-rows-[1.5fr_1fr] min-h-full min-w-full gap-x-8 gap-y-5">
            ...
            <div className="flex flex-col items-start gap-8  justify-between">
                ...
                <button className="bg-soft-red text-white px-8 py-3 tracking-widest">
                    READ MORE
                </button>
            </div>
        </div>
